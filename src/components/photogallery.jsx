                ...
                <ImageGallery 
                  ...
                  renderLeftNav={(onClick, disabled) => (
                    <button
                      onClick={onClick}
                      disabled={disabled}
                      className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/95 hover:bg-white rounded-full p-4 shadow-xl hover:shadow-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed border-2 border-gray-200 hover:border-[#ff7612]"
                    >
                  ...
                  renderRightNav={(onClick, disabled) => (
                    <button
                      onClick={onClick}
                      disabled={disabled}
                      className="absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/95 hover:bg-white rounded-full p-4 shadow-xl hover:shadow-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed border-2 border-gray-200 hover:border-[#ff7612]"
                    >
                      <svg className="w-8 h-8 text-[#461711]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  renderFullscreenButton={(onClick, isFullscreen) => (
                    <button
                      onClick={onClick}
                      className="absolute bottom-4 right-4 z-20 bg-white/95 hover:bg-white rounded-full p-4 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-200 hover:border-[#ff7612]"
                    >
                      <svg className="w-8 h-8 text-[#461711]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        {isFullscreen ? (
