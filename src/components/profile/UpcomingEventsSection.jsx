                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-end pt-2">
                           <button
                             ...
                             className={`px-6 py-2 rounded-lg transition font-medium text-white flex items-center justify-center gap-2 ${
                               registerStatus[event.eventID] === "success" || registerStatus[event.eventID] === "already"
                                 ? "bg-gray-400 cursor-not-allowed"
                                 : "bg-[#A64200] hover:bg-[#8a3600]"
                             }`}
                           >
