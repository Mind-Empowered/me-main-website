          ...
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-screen overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              {selectedEvent.bannerURL && (
                <img
                  src={selectedEvent.bannerURL}
                  alt={selectedEvent.bannerAltText || selectedEvent.title}
                  className="w-full h-64 object-cover rounded-lg"
                />
              )}
              ...
              {selectedEvent.venue && (
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <FaMapMarkerAlt className="text-[#A64200]" />
                    <span className="text-gray-600 text-sm font-medium">
                      Venue
                    </span>
                  </div>
                  ...
                  {/* Map Link */}
                  {selectedEvent.venue_url && (
                    <a
                      href={selectedEvent.venue_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#A64200] text-sm hover:underline mt-2 inline-block"
                    >
                      📍 View on Map →
                    </a>
                  )}
              ...
              {/* Food Availability */}
              {selectedEvent.is_food_available && (
