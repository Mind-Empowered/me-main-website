...
const Calendar = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from("calendars").getPublicUrl(fileName);
  ...
  const handleDelete = async (id) => {
    const confirmDelete = confirm("Delete this calendar permanently?");
            ...
            {file && (
              <div className="mt-5 flex justify-between items-center bg-[#FAF6F1] p-4 rounded-xl">
                ...
                <button
                  ...
                  className="bg-gray-300 hover:bg-gray-400 text-gray-700 p-2 rounded-lg transition"
                >
                  <FaTimes />
                </button>
              </div>
